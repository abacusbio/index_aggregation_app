...
#   dup_desc_bv <- desc_bv
#   colnames(dup_desc_bv)[2] <- "column_labelling"
...
#   no_ID_desc_ebv <- subset(desc_bv, column_labelling != "ID")
...
# test_that("sanityCheckEBVdesc() checks if required classifiers exist", {
...
# # in the column_labelling column of the input file.
